...
{
    long int soma[nEtapas], media[nEtapas];
    for (int i = 0; i < nEtapas; i++)
    {
        soma[i] = 0;
    }
 ...
 * @see infoEtapas,infoTempos,infoDistancias,infoPiloto,infoProva,menu
 */
 ...
 * @see infoEtapas,infoTempos,infoDistancias,infoPiloto,infoProva,Etapas,loadTempos,loadDistancias,arrumarVetor,nPilotosCount,loadProva,loadVerificaProva,menu
 */
